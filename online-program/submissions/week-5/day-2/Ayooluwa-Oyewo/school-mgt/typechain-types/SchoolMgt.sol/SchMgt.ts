...
export declare namespace SchMgt {
...
export interface SchMgtInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getAllStudents"
      | "principal"
...
export interface SchMgt extends BaseContract {
  connect(runner?: ContractRunner | null): SchMgt;
  waitForDeployment(): Promise<this>;

  interface: SchMgtInterface;
  ...
  ): TypedContractMethod<[], [SchMgt.StudentStructOutput[]], "view">;
  getFunction(
